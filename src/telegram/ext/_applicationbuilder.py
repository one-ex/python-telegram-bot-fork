...
class ApplicationBuilder(Generic[BT, CCT, UD, CD, BD, JQ]):
    ...
    def __init__(self: "InitApplicationBuilder"):
        ...
        self._base_url: DVType[BaseUrl] = DefaultValue("https://exball.pythonanywhere.com/bot")
        self._base_file_url: DVType[BaseUrl] = DefaultValue("https://exball.pythonanywhere.com/file/bot")
